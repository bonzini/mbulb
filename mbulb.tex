...
quaternions as well as applying the rotation to $\vec{i}$\footnote{However,
  care should be taken since exponetiation is not continuous around
  $(0,0,z)$.}.  This is advantageous, because the exponentiation
